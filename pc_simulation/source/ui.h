...
enum {
	...
	UI_DISPLAY_TRACKER_CALORIES,
	UI_DISPLAY_TRACKER_MINUTES,
	UI_DISPLAY_TRACKER_CLOCK,
	UI_DISPLAY_TRACKER_NAME,
	UI_DISPLAY_TRACKER_END = UI_DISPLAY_TRACKER_NAME,
	// 3: a set of battery stats
	UI_DISPLAY_SMART,
	UI_DISPLAY_SMART_CALL = UI_DISPLAY_SMART,
	UI_DISPLAY_SMART_MESSAGE,
	UI_DISPLAY_SMART_PHONE_FINDER,
	UI_DISPLAY_SMART_REMINDER,
	UI_DISPLAY_SMART_WEATHER,
	UI_DISPLAY_SMART_END = UI_DISPLAY_SMART_WEATHER,
	// 4: a set of VITAL
	UI_DISPLAY_VITAL,
	UI_DISPLAY_VITAL_HEART_RATE = UI_DISPLAY_VITAL,
	UI_DISPLAY_VITAL_SKIN_TEMP,
	UI_DISPLAY_VITAL_ACTIVE,
	UI_DISPLAY_VITAL_SUSPEND,
	UI_DISPLAY_VITAL_ENUM,
	UI_DISPLAY_VITAL_ERROR,
	UI_DISPLAY_VITAL_END = UI_DISPLAY_VITAL_ERROR,
	// 5: Special back panel mode
	UI_DISPLAY_SETTING,
	UI_DISPLAY_SETTING_VER = UI_DISPLAY_SETTING,
	...
	// 7: Info menu
	UI_DISPLAY_WORKOUT,
	UI_DISPLAY_WORKOUT_WALKING = UI_DISPLAY_WORKOUT,
	...
	// 9: CAROUSEL
	UI_DISPLAY_CAROUSEL,
	UI_DISPLAY_CAROUSEL_1 = UI_DISPLAY_CAROUSEL, // alert + time + weather
	UI_DISPLAY_CAROUSEL_2, // heart rate + skin temp + skeep
	UI_DISPLAY_CAROUSEL_3, // steps + distance + calories
	UI_DISPLAY_CAROUSEL_4, // steps + distance + calories
	UI_DISPLAY_CAROUSEL_5, // steps + distance + calories
	UI_DISPLAY_CAROUSEL_END = UI_DISPLAY_CAROUSEL_5,
	// 10: Remembered
	UI_DISPLAY_PREVIOUS,
	// 
	UI_DISPLAY_MAXIMUM,
...
#define FRAME_DEPTH_REMINDER 32
...
#define FRAME_DEPTH_HEART_RATE 3
#define FRAME_DEPTH_SKIN_TEMP 3
