...
enum {
  ...
  UI_DISPLAY_SMART_SOS_ALERT,	//23
	...
	UI_DISPLAY_VITAL_SKIN_TEMP, //25
	UI_DISPLAY_VITAL_END = UI_DISPLAY_VITAL_SKIN_TEMP,
	// 5: Special back panel mode
	UI_DISPLAY_SETTING,
	UI_DISPLAY_SETTING_VER = UI_DISPLAY_SETTING, //26
	UI_DISPLAY_SETTING_END = UI_DISPLAY_SETTING_VER,
	// 6: Stopwatch
	UI_DISPLAY_STOPWATCH,
	UI_DISPLAY_STOPWATCH_START = UI_DISPLAY_STOPWATCH,	//27
	UI_DISPLAY_STOPWATCH_STOP, //28	                      
	UI_DISPLAY_STOPWATCH_END = UI_DISPLAY_STOPWATCH_STOP,
	// 7: Workout mode
	UI_DISPLAY_WORKOUT,
	UI_DISPLAY_WORKOUT_TREADMILL= UI_DISPLAY_WORKOUT, //29	
	UI_DISPLAY_WORKOUT_CYCLING, //30	
	UI_DISPLAY_WORKOUT_STAIRS, //31
	UI_DISPLAY_WORKOUT_ELLIPTICAL, //32
	UI_DISPLAY_WORKOUT_ROW, //33	
	UI_DISPLAY_WORKOUT_AEROBIC, //34	
	UI_DISPLAY_WORKOUT_PILOXING, //35	
	UI_DISPLAY_WORKOUT_OTHERS, //36	
	UI_DISPLAY_WORKOUT_RT_READY, //37		
	UI_DISPLAY_WORKOUT_RT_TIME,	//38		
	UI_DISPLAY_WORKOUT_RT_HEART_RATE, //39	
	UI_DISPLAY_WORKOUT_RT_CALORIES,	//40		
	UI_DISPLAY_WORKOUT_RT_END,	//41		
	UI_DISPLAY_WORKOUT_END = UI_DISPLAY_WORKOUT_RT_END,
	// 8: Running Statistics
	UI_DISPLAY_RUNNING_STATATISTICS,	
	UI_DISPLAY_RUNNING_STAT_DISTANCE = UI_DISPLAY_RUNNING_STATATISTICS, //42   
	UI_DISPLAY_RUNNING_STAT_TIME, //43
	UI_DISPLAY_RUNNING_STAT_PACE, //44
	UI_DISPLAY_RUNNING_STAT_STRIDE, //45
	UI_DISPLAY_RUNNING_STAT_CADENCE, //46
	UI_DISPLAY_RUNNING_STAT_HEART_RATE, //47
	UI_DISPLAY_RUNNING_STAT_CALORIES, //48
  ...
  UI_DISPLAY_TRAINING_STAT_START = UI_DISPLAY_TRAINING_STATATISTICS, //49    
 	UI_DISPLAY_TRAINING_STAT_START_OR_ANALYSIS, //50	
  UI_DISPLAY_TRAINING_STAT_READY, //51    
	UI_DISPLAY_TRAINING_STAT_TIME, //52	
	UI_DISPLAY_TRAINING_STAT_DISTANCE, //53
	UI_DISPLAY_TRAINING_STAT_PACE, //54
	UI_DISPLAY_TRAINING_STAT_HEART_RATE, //55	
	UI_DISPLAY_TRAINING_STAT_RUN_STOP,	//56	
  ...
  UI_DISPLAY_CYCLING_OUTDOOR_STAT_START = UI_DISPLAY_CYCLING_OUTDOOR_STATATISTICS, //57     	
  UI_DISPLAY_CYCLING_OUTDOOR_STAT_READY, //58  
	UI_DISPLAY_CYCLING_OUTDOOR_STAT_TIME, //59	
	UI_DISPLAY_CYCLING_OUTDOOR_STAT_DISTANCE, //60 
	UI_DISPLAY_CYCLING_OUTDOOR_STAT_SPEED, //61	
	UI_DISPLAY_CYCLING_OUTDOOR_STAT_HEART_RATE, //62	
	UI_DISPLAY_CYCLING_OUTDOOR_STAT_STOP,	//63	
	UI_DISPLAY_CYCLING_OUTDOOR_STATATISTICS_END = UI_DISPLAY_CYCLING_OUTDOOR_STAT_STOP,	
	// 11: CAROUSEL
	UI_DISPLAY_CAROUSEL,
	UI_DISPLAY_CAROUSEL_1 = UI_DISPLAY_CAROUSEL, // Running mode + Riding mode + Workout mode  //64	
	UI_DISPLAY_CAROUSEL_2, // Message + Stopwatch + Weather   //65	
	UI_DISPLAY_CAROUSEL_3, // PM2.5 + Alarm + Setting       //66	
