...
static void _fill_vertical_calories(char *string)
{
	...
	I8U len, margin;
	I8U b_24_size = 24;
	I32U v_10000, v_1000, v_100, v_10, v_1;
...
{	
	...
	// Bottom row
	if ((middle == UI_MIDDLE_MODE_SKIN_TEMP) || (middle == UI_MIDDLE_MODE_HEART_RATE)) {
		_right_row_render(bottom, FALSE);
	} else {
