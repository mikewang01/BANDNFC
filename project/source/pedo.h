...
//
#define CLASSIFIER_WRC_1_TH  (I32S)12582912 /*(3.0*NOMINAL_G_MAG) */
#define CLASSIFIER_WRC_2_TH  (I32S)9646899 /*(2.3*NOMINAL_G_MAG) */

#define CLASSIFIER_WRC_PURE_WALK_TH  (I32S)6710886 /*(1.6*NOMINAL_G_MAG) */
