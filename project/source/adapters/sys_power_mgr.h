...
#define  dg_configPM_MAX_ADAPTERS_CNT 3
 ...
 *
 * \warning If the returned value equals dg_configWAKEUP_XTAL16_TIME, then this
 *          MAC will either not sleep, or sleep forever
 *
 */
uint32_t pm_get_mac_wakeup_time(pm_id_t id);
